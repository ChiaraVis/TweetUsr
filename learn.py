...
X=np.asarray(pickle.load(open('X.pickle')))
Y1=np.asarray(pickle.load(open('Y1.pickle')))
Y2=np.asarray(pickle.load(open('Y2.pickle')))
...
clf=Pipeline([('scaler',StandardScaler()),('clf',SVC(probability=True))])
